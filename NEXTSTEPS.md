...
# Next Steps for ndx-cabmi Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-cabmi directory: `cd ndx-cabmi`
...
`spec/ndx-cabmi.namespace.yaml` and
`spec/ndx-cabmi.extensions.yaml` files.

6. Define API classes for your new extension data types.

    - As a starting point, `src/pynwb/ndx_cabmi/__init__.py` includes an
...
`src/pynwb/ndx_cabmi/tests` or `src/matnwb/tests`.
...
`src/pynwb/ndx_cabmi/widgets` so that the visualizations can be displayed with
[nwbwidgets](https://github.com/NeurodataWithoutBorders/nwbwidgets).
You will also need to update the `vis_spec` dictionary in 
`src/pynwb/ndx_cabmi/widgets/__init__.py` so that
...
2. Start a git repository for your extension directory ndx-cabmi
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/senis000/ndx-cabmi/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).
...
9. Publish your updated extension on [PyPI](https://pypi.org/).
    ...
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-cabmi/0.1.0
...
`staged-extensions/ndx-cabmi`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-cabmi
    ```

13. Edit `staged-extensions/ndx-cabmi/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      name: ndx-cabmi
      version: 0.1.0
      src: https://github.com/senis000/ndx-cabmi
      pip: https://pypi.org/project/ndx-cabmi/
      license: BSD-3-Clause
      maintainers: 
        - senis000
      ```

14. Edit `staged-extensions/ndx-cabmi/README.md`
to add information about your extension. You may copy it from
`ndx-cabmi/README.md`.

  ```bash
  cp ndx-cabmi/README.md staged-extensions/ndx-cabmi/README.md
  ```
...
git add ndx-cabmi
git commit -m "Add new catalog entry for ndx-cabmi" .
git push
```
...
ndx-cabmi-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-cabmi GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-cabmi-record repository on GitHub.
